...
{
    [NodeMenuItem("逻辑/客户端条件"), GameEventNode, Serializable]
    public class ClientConditionNode : ClientNodeBase
    {
        public override string name => "";

        public override FlowNodeType Type => FlowNodeType.ClientCondition;
