...
namespace GraphProcessor
{
    public class PortView : Port
    {
            ...
            : base(portData.vertical ? Orientation.Vertical : Orientation.Horizontal, direction, Capacity.Multi, portData.displayType ?? fieldInfo.FieldType)
        {
            ...
            this.AddEdgeConnectorListener();
        }

        private void AddEdgeConnectorListener()
        {
            this.m_EdgeConnector = new BaseEdgeConnector(this.listener);
        ...
        {
            return new PortView(direction, fieldInfo, portData, edgeConnectorListener);
        }
        ...
        public virtual void UpdatePortView(PortData data)
        {
