...
namespace GraphProcessor
{
    ...
    public class BaseNodeView : NodeView
    {
        ...
        void InitializeView()
        {
            ...
            SetNodeColor(nodeTarget.titleColor);
            SetRootNodeColor(nodeTarget.color);
            AddInputContainer();
        ...
        protected virtual void SetRootNodeColor(Color color)
        {
            ...
            var borderWidth = 0.03f;

            this.mainContainer.style.borderTopWidth = borderWidth;
            this.mainContainer.style.borderBottomWidth = borderWidth;
            this.mainContainer.style.borderRightWidth = borderWidth;
            this.mainContainer.style.borderLeftWidth = borderWidth;

            var borderRadius = 3;

            this.mainContainer.style.borderTopRightRadius = borderRadius;
            this.mainContainer.style.borderTopLeftRadius = borderRadius;
            this.mainContainer.style.borderBottomLeftRadius = borderRadius;
            this.mainContainer.style.borderBottomRightRadius = borderRadius;
        }
        ...
        protected VisualElement AddControlField(FieldInfo field, string label = null, bool showInputDrawer = false, Action valueChangedCallback = null)
        {
            ...
            var customSetting = field.GetCustomAttribute<CustomSettingAttribute>();
